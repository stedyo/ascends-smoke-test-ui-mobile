...
const ChatButton = ({isWhite, style, navigation}) => (
  <TouchableOpacity style={[styles.button, style]} onPress={() => navigation.navigate('Categories')}>
    <Icon
      family="GalioExtra"
      size={16}
      name="chat-33"
  ...
  renderSearch = () => {
    ...
    return (
      <Input
        ...
        color="black"
        style={styles.search}
        placeholder="Search New Communities to Join"
    ...
    return (
      <Block row style={styles.tabs}>
        ...
        <Button shadowless style={styles.tab} onPress={() => navigation.navigate('Pro')}>
          <Block row middle>
            <Icon size={16} name="filter" family="font-awesome" style={{ paddingRight: 8 }} />
            <Text size={16} style={styles.tabTitle}>{tabTitleRight || 'Filter'}</Text>
          </Block>
        </Button>
      </Block>
    )
