...
export declare function goBack(fromKey?: null | string): {
    ...
    type: "RESET";
    payload: import("@react-navigation/routers").NavigationState | import("@react-navigation/routers").PartialState<import("@react-navigation/routers").NavigationState> | (Pick<import("@react-navigation/routers").NavigationState, "key" | "stale" | "type" | "routeNames" | "index" | "history"> & {
        routes: Pick<import("@react-navigation/routers").Route<string>, "params" | "name">[];
    });
    source?: string | undefined;
    target?: string | undefined;
} | {
