...
class SetupIosDist {
  ...
  async open(ctx) {
    ...
    const isValid = await iosDistView().validateDistributionCertificate(ctx.appleCtx, configuredDistCert);
...
//# sourceMappingURL=../../__sourcemaps__/credentials/views/SetupIosDist.js.map
