...
async function action(projectDir = './') {
  ...
  _log().default.warn('\u203A The expo optimize command is no longer included in expo-cli, please refer to the expo-optimize README at https://git.io/Je9h6 for a drop-in replacement.');
}
