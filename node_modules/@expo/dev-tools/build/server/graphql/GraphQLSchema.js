...
const resolvers = {
  ...
  Mutation: {
    openWeb(parent, props, context) {
      return (0, _asyncToGenerator3.default)(function* () {
        const currentProject = context.getCurrentProject();
        try {
          yield _xdl.Webpack.openAsync(currentProject.projectDir);
    ...
    setProjectConfig(parent, { input }, context) {
      return (0, _asyncToGenerator3.default)(function* () {
        ...
        var _ref2 = yield (0, _config.writeConfigJsonAsync)(currentProject.projectDir, filteredInput);
